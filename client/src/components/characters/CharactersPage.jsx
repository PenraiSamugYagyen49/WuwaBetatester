...
export default function CharactersPage({ navigate }) {
  ...
  return <main className="characters-page">
    <section className="characters-hero"><div><p className="signal">SOLARIS-3 · RESONATOR ARCHIVE</p><h1>Resonators</h1></div><CharacterFilters filters={filters} onChange={updateFilter} onReset={() => setFilters(initialFilters)} isActive={isActive} /></section>
